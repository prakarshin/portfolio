...
export interface Project { title: string; type: string; role: string; description: string; focus: string[]; url?: string; }
...
export interface PortfolioData {
  ...
  skills: SkillGroup[];
  education: { degree: string; institution: string; duration: string; cgpa: string; };
}
